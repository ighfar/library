...
@section('title', __('general.title_add', ['field' => $this_label]))
...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                {{ __('general.title_add', ['field' => $this_label]) }}
            </h1>
            <ol class="breadcrumb">
                ...
                <li class="active">{{ __('general.title_add', ['field' => $this_label]) }}</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ __('general.title_add', ['field' => $this_label]) }}</h3>
                        </div>

                        {{ Form::open(['route' => ['admin.' . $this_route . '.store'], 'files' => true, 'id'=>'form', 'role' => 'form', 'novalidate'=>'novalidate'])  }}
                        <div class="box-body">

                            @foreach($passing as $field_name => $field_data)
                                @php
                                $list_passing = ['field_name' => $field_name, 'field_value' => null, 'field_lang' => $field_data->lang, 'field_message'=>$field_data->field_message, 'add_attribute'=>$add_attribute];
